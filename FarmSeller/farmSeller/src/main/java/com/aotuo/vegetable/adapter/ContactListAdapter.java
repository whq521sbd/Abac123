...
public class ContactListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View v, ViewGroup parent) {
        ...
        ContactEntity ce = list.get(position);
        vh.name.setText(ce.getRecName());
        if ("1".equals(ce.getUserType()))
            vh.addr.setText(ce.getMarketName() + ce.getBooth());
        else
            vh.addr.setText(ce.getComName());
        vh.time.setText(ce.getLastTime());
        return v;
    }
