...
//		long hours = (time % (24 * 60 * 60)) / (60 * 60); //带有天的时候计算的小时
		long hours = time/ (60 * 60);
		long minutes = ((time % (24 * 60 * 60)) % (60 * 60)) / 60; 
		long second = ((time % (24 * 60 * 60)) % (60 * 60)) % 60; 
//		long haomiao=(((time % (24 * 60 * 60)) % (60 * 60)) / 60)%1000;
//		String dayStr = String.valueOf(day); 
		String hoursStr = timeStrFormat(String.valueOf(hours)); 
		String minutesStr = timeStrFormat(String.valueOf(minutes)); 
		String secondStr = timeStrFormat(String.valueOf(second)); 
//		String haomiaoStr=timeStrFormat(String.valueOf(haomiao));
...
//		.append(minutesStr).append("分钟").append(secondStr).append("秒"); 
		...
		//用来设置不同的Span，这些Span便是用于实现Rich Text，比如粗体，斜体，前景色，背景色，字体大小，字体风格等等，
//		if (day >= 10) { 
...
//			((Spannable) str).setSpan(new AbsoluteSizeSpan(16), 2, 3, 
//					Spannable.SPAN_EXCLUSIVE_EXCLUSIVE); 
//			((Spannable) str).setSpan(new AbsoluteSizeSpan(16), 5, 6, 
//					Spannable.SPAN_EXCLUSIVE_EXCLUSIVE); 
//			((Spannable) str).setSpan(new AbsoluteSizeSpan(16), 7, 7, 
//					Spannable.SPAN_EXCLUSIVE_EXCLUSIVE); 
//		} 
