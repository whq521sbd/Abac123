...
public class LineChartActivity extends FragmentActivity {
    ...
    private final static String TAG_COLUME="column";
    private final static String TAG_PIE="pie";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        popupMenu = new PopupMenu(this, rightBtn);
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                if(item.getItemId() == R.id.action_line){
                    showFragments(TAG_LINE, false);
                } else if(item.getItemId() == R.id.action_column){
                    showFragments(TAG_COLUME, false);
                } else if(item.getItemId() == R.id.action_pie){
                    showFragments(TAG_PIE, false);
                }
                return false;
            }
        });
    ...
    private void initFragment(){
        lineFragment = new LineChartActivity.PlaceholderFragment();
        columnFragment = new ColumnChartActivity.PlaceholderFragment();
        pieFragment = new PieChartActivity.PlaceholderFragment();
    ...
    private void showFragments(String tag, boolean needback){
        ...
        if(needback){
            ...
            //        R.anim.frag_exit);
            trans.add(R.id.container, getFragmentByTag(tag), tag);
            trans.addToBackStack(tag);
        }else{
            trans.replace(R.id.container, getFragmentByTag(tag), tag);
        }
        trans.commit();
    }
    ...
    private Fragment getFragmentByTag(String tag){
        if(TAG_LINE.equals(tag)){
            return lineFragment;
        } else if(TAG_COLUME.equals(tag)){
            return columnFragment;
        } else if(TAG_PIE.equals(tag)){
            return pieFragment;
        }
