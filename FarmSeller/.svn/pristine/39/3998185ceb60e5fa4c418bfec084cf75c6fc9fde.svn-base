...
public class CropImageView extends View {
	...
	public void setMoveState(boolean isCanMove) {
	...
	public void setProportion1_1() {// 640X175
		setMoveState(false);
		mDrawableFloat.set(100 + mDx , 100 + mDy , 275 + mDx , 235 + mDy);
		invalidate();
	}
	public void setProportion4_3() {
		setMoveState(false);
		mDrawableFloat.set(200 , 200 , 600 , 800);
		invalidate();
	}
	
	public void setProportion3_4() {
		setMoveState(false);
		mDrawableFloat.set(100 , 100 , 700 , 500);
		invalidate();
	}
	...
	public Bitmap getCropImage() {
		...
		if (mDrawableFloat.height() > tmpBitmap.getHeight()) {
			mDrawableFloat.set(mDrawableFloat.left, mDrawableFloat.top, mDrawableFloat.width(), tmpBitmap.getHeight());
		}
		
		Log.i("tmpBitmap", "tmpbitmap-height----->" + tmpBitmap.getHeight() );
		Log.i("new-bitmap", "new-bitmap-height------>" + mDrawableFloat.height() +"+" +  mDrawableFloat.top +"=" + mDrawableFloat.height() + mDrawableFloat.top); 
